...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="card bg-white rounded-2xl shadow-lg p-6 text-center transition-transform transform-gpu hover:scale-105 hover:shadow-2xl hover:bg-blue-10 transition-colors duration-300">
                <h2 class="text-xl font-bold mb-2">All Teachers</h2>
                <p class="text-gray-600 mb-4">Easily Manage Teachers Activities.</p>
                <a href="teachers/view_teacher.php" class="bg-blue-500 text-white px-4 py-2 rounded-full hover:bg-blue-600 transition duration-300">Go</a>
            </div>
            <div class="card bg-white rounded-2xl shadow-lg p-6 text-center transition-transform transform-gpu hover:scale-105 hover:shadow-2xl hover:bg-blue-10 transition-colors duration-300">
                <h2 class="text-xl font-bold mb-2">Add Teacher</h2>
                <p class="text-gray-600 mb-4">Easily Manage Teachers Activities.</p>
                <a href="teachers/add_teacher.php" class="bg-blue-500 text-white px-4 py-2 rounded-full hover:bg-blue-600 transition duration-300">Go</a>
            </div>
            <div class="card bg-white rounded-2xl shadow-lg p-6 text-center transition-transform transform-gpu hover:scale-105 hover:shadow-2xl hover:bg-blue-10 transition-colors duration-300">
